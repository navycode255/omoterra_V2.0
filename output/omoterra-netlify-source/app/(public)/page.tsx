  ...
  return (
    <main className="marketing-site">
      ...
      <section className="marketing-hero" id="home">
        <div className="hero-photo" role="img" aria-label="Tanzanian farmer holding a young calf at a livestock market" />
      ...
      <footer className="marketing-footer">
        ...
        <div className="footer-meta"><Link href="/sign-in">Operations login</Link><span>© 2026 Omoterra. All rights reserved.</span></div>
      </footer>
    </main>
  );
}
