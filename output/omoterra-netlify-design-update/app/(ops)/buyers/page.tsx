...
export default async function Buyers() {
  let buyers: Buyer[];
  try { buyers = await get<Buyer[]>('/ops/buyer-crm'); }
  ...
  return <>
    ...
    <div className="workspace">
      <div className="grid-2" style={{ alignItems: 'start' }}>
        <div className="table-wrap">{buyers.length === 0 ? <Empty>No buyers recorded yet.</Empty> : <table><thead><tr><th>Business</th><th>Buyer type</th><th>Contact</th><th>Location</th><th>Record</th></tr></thead><tbody>{buyers.map((buyer) => <tr key={buyer.id}>
