...
export const Icons = {
  ...
  sort: (props: IconProps) => <Icon {...props}><path d="m8 9 4-4 4 4M8 15l4 4 4-4"/></Icon>,
  trend: (props: IconProps) => <Icon {...props}><path d="M3 20h18M5 16l5-5 3 3 6-7"/><path d="M15 7h4v4"/></Icon>,
  ...
  trash: (props: IconProps) => <Icon {...props}><path d="M4 7h16M10 11v6M14 11v6M6 7l1 13h10l1-13M9 7V4h6v3"/></Icon>,
  video: (props: IconProps) => <Icon {...props}><rect x="3" y="6" width="13" height="12" rx="2"/><path d="m16 10 5-3v10l-5-3"/></Icon>,
  play: (props: IconProps) => <Icon {...props} fill="currentColor" stroke="none"><path d="M8 5.5v13a1 1 0 0 0 1.5.9l10.5-6.5a1 1 0 0 0 0-1.8L9.5 4.6A1 1 0 0 0 8 5.5Z"/></Icon>,
  refresh: (props: IconProps) => <Icon {...props}><path d="M20 11a8 8 0 0 0-14.3-4.9L4 8M4 4v4h4M4 13a8 8 0 0 0 14.3 4.9L20 16M20 20v-4h-4"/></Icon>,
